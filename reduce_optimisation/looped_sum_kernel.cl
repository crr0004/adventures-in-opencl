...
*/
	...
	if(get_global_id(0) == get_global_size(0)-1 ){
		...
		float16 nums2 = vload16(1*16, (const __local float*)workBuffer);
		float16 num1_2 = nums1+nums2;


		float16 nums3 = vload16(2*16, (const __local float*)workBuffer);
		float16 nums4 = vload16(3*16, (const __local float*)workBuffer);
